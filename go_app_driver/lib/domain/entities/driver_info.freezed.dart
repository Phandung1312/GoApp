...
class _$DriverInfoImpl implements _DriverInfo {
  ...
  @override
  String toString() {
    return 'DriverInfo(id: $id, fullName: $fullName, gender: $gender, nonBlock: $nonBlock, email: $email, phoneNumber: $phoneNumber, status: $status, dateOfBirth: $dateOfBirth, avtUrl: $avtUrl, idCard: $idCard, licensePlate: $licensePlate, rating: $rating, drivingLicense: $drivingLicense, vehicleType: $vehicleType)';
  }
...
abstract class _DriverInfo implements DriverInfo {
  const factory _DriverInfo(
      ...
      final double rating,
      final String drivingLicense,
      final VehicleType vehicleType}) = _$DriverInfoImpl;
